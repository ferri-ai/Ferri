...
func (c *TelegramChannel) Send(ctx context.Context, msg bus.OutboundMessage) error {
	...
	logger.InfoCF("telegram", "Sending response", map[string]interface{}{
		"chat_id": msg.ChatID,
	...
	if pID, ok := c.placeholders.Load(msg.ChatID); ok {
		...
		logger.WarnCF("telegram", "Placeholder edit failed, falling back to new message", map[string]interface{}{
			"chat_id": msg.ChatID,
			"error":   err.Error(),
		})
	}
